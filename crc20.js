...
const configTest = {
  api: 'ws://45.76.187.40:8080',
  account: 'your 12 seed phrase',
};

const configProd = {
  api: 'wss://api-ivy-elastic.clover.finance',
  account: 'your 12 seed phrase',
};

const IS_DEV = true;
const config = IS_DEV ? configTest : configProd;
